<template>
  <div class="card">
    ...
    <div class="card-body">
      <UserFilter model="videocards" @filter-change="onFilterChange" />
      ...
      <div class="row mt-3 mb-4">
        ...
        <div class="col-md-3">
          <div class="card text-bg-success">
            <div class="card-body">
              <h5 class="card-title">Ср. память</h5>
              <p class="card-text display-6">{{ stats.avg_memory?.toFixed(1) || 0 }} ГБ</p>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="card text-bg-warning">
            <div class="card-body">
              <h5 class="card-title">Макс. память</h5>
              <p class="card-text display-6">{{ stats.max_memory || 0 }} ГБ</p>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="card text-bg-danger">
            <div class="card-body">
              <h5 class="card-title">Мин. память</h5>
              <p class="card-text display-6">{{ stats.min_memory || 0 }} ГБ</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col">
          <input type="number" class="form-control" v-model="filters.memory" placeholder="Фильтр по памяти" @input="applyFilters">
        </div>
        <div class="col">
          <input type="text" class="form-control" v-model="filters.chipset" placeholder="Фильтр по чипсету" @input="applyFilters">
        </div>
        <div class="col-auto">
      ...
      <form @submit.prevent="onAdd" class="mb-4">
        <div class="row">
          ...
          <div class="col">
            <input type="number" class="form-control" v-model="newItem.memory" placeholder="Память (ГБ)" required>
          </div>
          <div class="col">
            <input type="text" class="form-control" v-model="newItem.chipset" placeholder="Чипсет" required>
          </div>
          <div class="col">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Редактировать видеокарту</h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            <input type="number" class="form-control" v-model="editItem.memory" placeholder="Память (ГБ)">
          </div>
          <div class="mb-2">
            <input type="text" class="form-control" v-model="editItem.chipset" placeholder="Чипсет">
          </div>
          <div class="mb-2">
